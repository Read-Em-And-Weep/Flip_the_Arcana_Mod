mod.NewMetaUpgradeCardData = 
{
	...
	ReversedDoorCashCard = -- Greed, Midas
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 5, OreNBronze = 8, MixerOBoss = 2 },
		},
	...
	ReversedLowHealthCrit = -- The Trapper, Orion
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 6, MixerShadow = 10, MixerHBoss = 2 },
		},
	...
	ReversedSturdyChannel = -- The Sky, Ouranos
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 4, OreChaosProtoplasm = 5 , WeaponPointsRare = 1},
			{ CardUpgradePoints = 6, OreChaosProtoplasm = 6, MixerPBoss = 2 },
		},
	...
	ReversedCharmedEnemy = -- The Witch, Pasiphaë
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, GiftPoints = 3 },
	...
	ReversedSharedRunProgress = -- Curiosity, Dora
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 6, MixerShadow = 2, MixerHBoss = 2 },
		},
	...
	ReversedOlympianDamage = -- The Automaton, Talos
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 6, OrePAdamant = 8, MixerNBoss = 2, },
		},
		--[[
		AutoEquipRequirements = 
		{
	...
	--Resource Director, House Contractor, Music Maker, Record Keeper, Learned Sage, Spirit Mixer, etc.
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 10, Mixer6Common = 5, MixerIBoss = 2, },
		},
	...
	ReversedStrongRush = -- Betrayal, Arke
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 1,OrePAdamant = 6},
			{ CardUpgradePoints = 3, MixerPBoss = 2, MixerIBoss = 1 },
		},
	...
	ReversedRenewableDD = -- Discipline, Skelly
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 6 , MetaCurrency = 50, OreHGlassrock = 2 },
	...
	ReversedArmorPerRoom = -- Cunning, Penelope
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, MetaFabric = 5, MixerNBoss = 1},
			{ CardUpgradePoints = 6, PlantPOlive = 6, MixerNBoss = 2 },
		},
	...
	ReversedStatusCrit = -- The Titaness, Rhea
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, OreQScales = 5, MixerQBoss = 1},
			{ CardUpgradePoints = 10, MixerIBoss = 1, MixerQBoss = 2 },
		},
	...
	ReversedEncounterHeal = -- Soul, Psyche and Eros
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 4, GiftPoints = 6, Mixer5Common = 2 },
			{ CardUpgradePoints = 6, SuperGiftPoints = 6, MixerPBoss = 2 },
		},
		UnlockedCardVoiceLines =
		{
			PreLineWait = 0.65,
	...
	ReversedExtraFeatures = -- Duty, Iris
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3 , MixerShadow = 3, PlantPIris = 6},
	...
	ReversedPerfectClearBoost = -- The Tides, Triton
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 10, PlantODriftwood = 10, MixerHBoss = 2 },
		},
	...
	ReversedHeroicRarity = -- Labyrinth, Ariadne
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3 , OreHGlassrock = 3, OreGLime = 6},
			{ CardUpgradePoints = 5, MetaFabric = 8, MixerFBoss = 2 },
		},
	...
	ReversedSacrificeForLevels = -- Sacrifice, Iphigenia
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 4,SuperGiftPoints = 3, Mixer5Common = 2 },
	...
	ReversedGatherRarity = -- The Earth, Gaia
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, OreGLime = 6 },
			{ CardUpgradePoints = 5, PlantQSnakereedSeed = 7, MixerOBoss = 2, },
		},
		AutoEquipRequirements = 
		{
	...
	ReversedPerfectPower = -- Victory, Nike
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, MixerIBoss = 1, MixerQBoss = 1},
			{ CardUpgradePoints = 10, MixerIBoss = 2, MixerQBoss = 2 },
		},
	...
	ReversedUnFatedReward = -- The Prophet, Cassandra
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, PlantOMandrake = 5, WeaponPointsRare = 2},
			{ CardUpgradePoints = 10, PlantOMandrake = 7, MixerQBoss =2 },
		},
	...
	ReversedFullDefiance = -- The Final Farewell, Hector, Andromache and Astyanax
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 6, OreOIron = 6, OreFSilver = 6},
			{ CardUpgradePoints = 12,MixerFBoss = 2, MixerNBoss = 2 },
		},
	...
	ReversedRandomBonusLevels = -- Temptation, Ganymede
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, SuperGiftPoints = 4, PlantPOlive = 7 },
			{ CardUpgradePoints = 10, Mixer5Common = 4, MixerGBoss = 2},
		},
	...
	ReversedCheaperChannel = -- Seer, Tiresias
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 5, MixerShadow = 6, MixerFBoss = 2 },
		},
	...
	ReversedPotentDefiance = -- Hatred, Styx
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 2, MixerShadow = 1, PlantIPoppy = 3},
	...
	ReversedSpellDamage = -- Dawn, Eos
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, MixerFBoss = 2 },
	...
	ReversedProjectileSlow = -- The Winds, Aeolus + the Anemoi
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, PlantQSnakereed = 3, PlantGCattail = 3},
			{ CardUpgradePoints = 6, PlantQSnakereed= 5, MixerPBoss= 2, },
		},
		--[[
		AutoEquipRequirements = 
		{
	...
	ReversedCursedLegendaryBoost = -- The Sun, Helios 
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, PlantFMoly = 8 },
	...
	ReversedFreeOmega = -- Elegance, Helen
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3,PlantGLotus = 4 },
			{ CardUpgradePoints = 6, PlantHMyrtle = 6, MixerOBoss = 2 },
		},
	...
	ReversedProtectionCooldown = -- Burden, Atlas
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 12, MixerIBoss = 1, MixerQBoss = 2 },
		},
	...
	ReversedElementRoom = -- Solitude, Calypso
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3, PlantHMyrtle = 5, SuperGiftPoints = 2},
	...
	ReversedManaShield = -- The Sculptor, Pygmalion and Galatea 
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 4, OreHGlassrock = 6, OreGLime = 6 },
	...
	ReversedRandomSacrifice = -- The Coven, Graeae
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 3 , MixerShadow = 3, PlantOMandrake = 8},
	...
	ReversedAdditionalOmegaChance = -- Mockery, Momus
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 10, OreGLime = 10, MixerGBoss = 2 },
		},
	...
	ReversedRiposteKill = -- The Warrioresses, The Amazons
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 5, MixerShadow = 6, MixerNBoss = 3 },
		},
	...
	ReversedArtemisKeepsake = -- Beasts, Monsters
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 10, PlantQFang = 8, MixerQBoss = 2 },
		},
	...
	ReversedFountainGold = -- The King, Agamemnon
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 5, SuperGiftPoints = 3, OrePAdamant = 4},
			{ CardUpgradePoints = 10, MixerGBoss = 2, MixerHBoss =2 },
		},
	...
	ReversedDDRefillBiomeStart = -- The Physician, Asclepius
	{
		...
		UpgradeResourceCost = 
		{
			{ CardUpgradePoints = 6, PlantIPoppySeed = 5, PlantOMandrake = 6},
			{ CardUpgradePoints = 12,PlantNMoss = 7, MixerNBoss = 2 },
		},
	...
	ReversedMoreSacrifices = -- The Garden, Lovers transformed into Plants
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 10, Mixer5Common = 4, MixerHBoss = 2},
		},
	...
	ReversedRandomBuild = -- Good Fortune, Tyche
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 20, MixerIBoss = 3, WeaponPointsRare = 2 },
		},
