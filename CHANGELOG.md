...
- Damage multipliers are now applied correctly
...
- Monstrosity (Typhon) loot will now obey the config of which cards are enabled
...
- Fixed an issue preventing auto equipped cards from unlocking if you didn't complete the incantation
...
[unreleased]: https://github.com/Read-Em-And-Weep/Flip_the_Arcana_Mod/compare/3.0.13...HEAD
